...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools tilebaits -i targets.fa -L 60 -O 30 -B`  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools aln2baits -i canid_mito_aln.fa -H haplotype -D -B`  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools aln2baits -i canid_mito_aln.fa -H haplotype -D -B -w -n -x -q 80 -z 140 -T DNA-DNA`  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools bed2baits -i canid_mito_aln.bed -r canid_mito_aln.fa -D -B`  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools annot2baits -i Ananku.gff -r Ananku.fa -U gene,tRNA -B`  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools checkbaits -i out-baits.fa -L 120 -c -n 40 -x 80 -w`  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools vcf2baits -i WDF20_X.raw.vcf.gz -r sequence.fasta -V 30 -t 40 -m 40 -d 20000 -D`
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools vcf2baits -i WDF20_X.raw.vcf.gz -r sequence.fasta -V 30 -t 40 -m 40 -d 20000 -L 80 -b 20 -D`  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools vcf2baits -i WDF20_X.raw.vcf.gz -r sequence.fasta -V 30 -t 40 -m 40 -d 20000 -L 80 -b 79 \`  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`-O 15 -k 3 -D`  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools vcf2baits -i WDF20_X.raw.vcf.gz -V 30 -t 40 -m 40 -d 20000 -p`
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools vcf2baits -i out-selected.vcf -r sequence.fasta -e -D`  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools vcf2baits -i WDF20_X.raw.vcf.gz -r sequence.fasta -V 30 -j -D`
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools vcf2baits -i WDF20_X.raw.vcf.gz -r sequence.fasta -V 30 -j -a -D`
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools stacks2baits -i example.sumstats.tsv -S -p -t 5`  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`baitstools stacks2baits -i example.sumstats.tsv -H -p -t 5 -A 0.025`  
